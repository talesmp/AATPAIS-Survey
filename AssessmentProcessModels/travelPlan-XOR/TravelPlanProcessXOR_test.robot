...
# robot -i planned TravelPlanProcessXOR_test.robot
*** Settings ***
...
TC_04 
    ...
    kwLogin
    kwFakerDataSetup
    kwStartEvent_1    argTest-rentCar=True    argTest-bookHotel=True    argTest-name=Survey Test
    kwMyTasks 
    kwTaskFlight    argTest-airlineCompanyName=Flight Test
    kwMyTasks 
    kwTaskHotel
    kwMyTasks 
    kwTaskCar
